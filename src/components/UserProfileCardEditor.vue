    ...
    <div class="profile-card">
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.username.$error">
          <span v-if="!$v.activeUser.username.required" class="form-error">This username field is required.</span>
          <span v-if="!$v.activeUser.username.unique" class="form-error">This username is taken. Choose another username.</span>
        </template>
      </div>
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.name.$error">
          <span v-if="!$v.activeUser.name.required" class="form-error">This name field is required.</span>
        </template>
      </div>
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.email.$error">
          <span v-if="!$v.activeUser.email.required" class="form-error">This email field is required.</span>
          <span v-else-if="!$v.activeUser.email.email" class="form-error">This is not a valid email address. Type your email correctly.</span>
          <span v-else-if="!$v.activeUser.email.unique" class="form-error">This email is taken. Use another email.</span>
        </template>
      </div>
